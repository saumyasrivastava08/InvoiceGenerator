...
exports.addProducts = async (req, res) => {
  ...
  if (!Array.isArray(products) || products.length === 0) {
    ...
    return res
      .status(400)
      .json({ message: "Products should be an array and cannot be empty" });
  }
